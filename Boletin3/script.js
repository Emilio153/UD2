...
function cuadricula_alumnos() {
    ...
    var alumnos = ["Fran", "Xexu", "canijo", "Vanesa", "Raquel", "Amanda"];
...
function almacenar_cookie() {
    ...
    arrayCookie.forEach(function (cookie) { return console.log("Cookie: " + cookie); });
    //Leemos una en concreto (lang)
    var cookieAbuscar = window.prompt("Que cookie quieres consultar");
    var valor = "";
    for (var i = 0; i < arrayCookie.length; i++) {
        var claveValor = arrayCookie[i].split("=");
