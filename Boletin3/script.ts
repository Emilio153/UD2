...
function cuadricula_alumnos(){
    let contenedor : HTMLDivElement = document.getElementById("container") as HTMLDivElement;
    let alumnos: string[] = ["Fran","Xexu","canijo", "Vanesa", "Raquel","Amanda"];
